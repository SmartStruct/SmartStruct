...
st.markdown(
    ...
    <section id="contact-us">
        ...
        <p>Email: support@smartstruct.com</p>
...
st.markdown(
    ...
    <section id="feedback">
        <h2>Feedback</h2>
        <p>Your feedback is valuable to us! Please let us know your thoughts about the SmartStruct platform. Your input helps us improve our services.</p>
        <p>Email your feedback to: feedback@smartstruct.com</p>
    </section>
    """,
    unsafe_allow_html=True,
)
