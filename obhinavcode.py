...
# Navigation bar with internal page links (simulated with query params)
st.markdown(
    """
    <div class="navbar">
        <a href="/?section=about-us">About Us</a>
        <a href="/?section=how-to-use">How to Use</a>
...
# Get query params to identify the section using st.query_params (new method)
query_params = st.query_params
section = query_params.get("section", [""])[0]

# Display content based on section query param
if section == "about-us":
    st.markdown(
        """
        <section id="about-us">
